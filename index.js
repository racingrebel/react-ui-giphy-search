...
var _giphySearchBar = require('./giphy-search-bar');

var _giphySearchBar2 = _interopRequireDefault(_giphySearchBar);

var _giphySearchResults = require('./giphy-search-results');
    ...
    value: function render() {
      ...
      if (!loaded) {
        resultsComponent = _react2.default.createElement(
          'div',
          { className: 'giphy-search-loading' },
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_giphySearchBar2.default, {
          autofocus: autofocus,
...
GiphySearch.propTypes = {
  maxRating: _propTypes2.default.string,
